...
std::any Connection::MakeRequest(
    ...
    const CimissClient::HandlerFunction& exception_handler) const {
...
CimissClient::HandlerFunction Connection::GeneratePackSuccessHandler(ResponseData* response_data) {
...
CimissClient::HandlerFunction Connection::GeneratePackFailureHandler(ResponseData* response_data) {
    return [response_data](const std::string& content) {
...
CimissClient::HandlerFunction Connection::GenerateExceptionHandler(ResponseData* response_data) {
